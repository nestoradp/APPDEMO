...
const RegetEmail = new RegExp(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/);
...
function FormLogin(props) {
    ...
    const HandleSubmitLogin=()=>{
        if(isValidatorEmail()&isValidatorPassword()&isValidatorTermin()&isValidatorCaptcha()){
            ...
            <Grid align="center" container>
                ...
                <Grid align="left" item xs={12} className={clases.GridForm}>
                    <FormControl variant="outlined" fullWidth>
                        <label style={{ marginBlockEnd:"-12px"}}>Correo Electronico*</label>
                        <TextField
                        ...
                        {ErrorEmail && (
                            <Grid style={{ marginTop: "5px", marginBlockEnd: "5px" }}>
                                <Typography className={clases.MsgError}>{ErrorEmail}</Typography>
                            </Grid>
                        ...
                        {ErrorPassword && (
                            <Grid style={{ marginTop: "5px", marginBlockEnd: "5px" }}>
                                <Typography className={clases.MsgError}>{ErrorPassword}</Typography>
                            </Grid>
                        ...
                        {ErrorTerms&& (
                            <Grid style={{ marginTop: "5px", marginBlockEnd: "5px" }}>
                                <Typography className={clases.MsgError}>{ErrorTerms}</Typography>
                            </Grid>
                        )}
                        ...
                        {  /*    <Grid container spacing={4}>
                            <Grid item xl={6}>
                                <Link to="/register">Restablecer contraseña</Link>
                        ...
                        <Box className={clases.Recaptcha} display={'flex'} flexDirection={'column'}>
                        ...
                        {ErrorCaptcha && (
                            <Grid style={{ marginTop: "5px", marginBlockEnd: "5px" }}>
                                <Typography className={clases.MsgError}>{ErrorCaptcha}</Typography>
                            </Grid>
